...
export function UnifiedLogin({ onOAuthLogin }: UnifiedLoginProps): React.ReactElement {
  ...
  return (
    <PageContainer onBackClick={handleBackToHome} maxWidthClass="max-w-3xl">
      ...
      <div className="mt-10">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm font-medium">
            <span className="px-6 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-900">Or continue with</span>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-wrap gap-4 justify-center">
          <button
            ...
            className="flex items-center justify-center gap-3 rounded-md bg-gray-50 dark:bg-gray-900 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-gray-100 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 focus-visible:ring-transparent"
          >
